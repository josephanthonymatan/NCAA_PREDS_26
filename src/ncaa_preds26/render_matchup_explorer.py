            ...
            function renderFaqs() {{
              ...
              const cards = [
                {{
                  ...
                  short: "rating system",
                  answer:
                    "Elo is a rating system created by Arpad Elo for chess. Higher Elo means a stronger expected team. Here I use the Elo gap between two teams to turn a matchup into an implied win probability."
                }},
                {{
                  question: "How do I use this?",
                  short: "click through the bracket",
                  answer:
                    "Click a team to advance it. If you leave a game alone, the higher-Elo team advances by default. As you make picks, later rounds update automatically so only legal matchups stay on the board."
                }},
                {{
                  question: "What is Monte Carlo simulation?",
                  short: "100,000 saved tournament runs",
                  answer:
                    `A Monte Carlo simulation reruns the tournament many times with randomness weighted by each matchup's odds. People use it in finance, game theory, risk modeling, and sports to estimate a full range of outcomes instead of one fixed bracket. This page uses ${{formatCount(APP_DATA.simulationCount)}} saved runs.`
                }},
                {{
                  question: "Who is going to win?",
                  short: `${{APP_DATA.hostCity}} final`,
                  answer:
                    `We can't predict the future. In this model, ${{topTeam}} won ${{topPct}} of the ${{formatCount(APP_DATA.simulationCount)}} saved tournaments. But even ${{longshot}} ${{longshotText}}. Dream on.`
                }},
              ];
